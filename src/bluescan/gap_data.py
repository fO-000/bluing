...
gap_type_names = {
    FLAGS                                          : "Flags",
    INCOMPLETE_LIST_OF_16_BIT_SERVICE_CLASS_UUIDS  : "Incomplete List of 16-bit Service Class UUIDs",
    COMPLETE_LIST_OF_16_BIT_SERVICE_CLASS_UUIDS    : "Complete List of 16-bit Service Class UUIDs",
    INCOMPLETE_LIST_OF_32_BIT_SERVICE_CLASS_UUIDS  : "Incomplete List of 32-bit Service Class UUIDs",
    COMPLETE_LIST_OF_32_BIT_SERVICE_CLASS_UUIDS    : "Complete List of 32-bit Service Class UUIDs",
    INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS : "Incomplete List of 128-bit Service Class UUIDs",
    COMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS   : "Complete List of 128-bit Service Class UUIDs",
    ...
    SIMPLE_PAIRING_HASH_C                          : "Simple Pairing Hash C",
    SIMPLE_PAIRING_HASH_C_192                      : "Simple Pairing Hash C-192",
    SIMPLE_PAIRING_RANDOMIZER_R                    : "Simple Pairing Randomizer R",
    SIMPLE_PAIRING_RANDOMIZER_R_192                : "Simple Pairing Randomizer R-192",
    DEVICE_ID                                      : "Device ID",
    SECURITY_MANAGER_TK_VALUE                      : "Security Manager TK Value",
    SECURITY_MANAGER_OUT_OF_BAND_FLAGS             : "Security Manager Out of Band Flags",
    SLAVE_CONNECTION_INTERVAL_RANGE                : "Slave Connection Interval Range",
    LIST_OF_16_BIT_SERVICE_SOLICITATION_UUIDS      : "List of 16-bit Service Solicitation UUIDs",
    LIST_OF_128_BIT_SERVICE_SOLICITATION_UUIDS     : "List of 128-bit Service Solicitation UUIDs",
    SERVICE_DATA                                   : "Service Data",
    SERVICE_DATA_16_BIT_UUID                       : "Service Data - 16-bit UUID",
    ...
    LE_ROLE                                        : "LE Role",
    SIMPLE_PAIRING_HASH_C_256                      : "Simple Pairing Hash C-256",
    SIMPLE_PAIRING_RANDOMIZER_R_256                : "Simple Pairing Randomizer R-256",
    LIST_OF_32_BIT_SERVICE_SOLICITATION_UUIDS      : "List of 32-bit Service Solicitation UUIDs",
    SERVICE_DATA_32_BIT_UUID                       : "Service Data - 32-bit UUID",
    SERVICE_DATA_128_BIT_UUID                      : "Service Data - 128-bit UUID",
    LE_SECURE_CONNECTIONS_CONFIRMATION_VALUE       : "LE Secure Connections Confirmation Value",
    LE_SECURE_CONNECTIONS_RANDOM_VALUE             : "LE Secure Connections Random Value",
    URI                                            : "URI",
    INDOOR_POSITIONING                             : "Indoor Positioning",
    TRANSPORT_DISCOVERY_DATA                       : "Transport Discovery Data",
    LE_SUPPORTED_FEATURES                          : "LE Supported Features",
    ...
    THREE_D_INFORMATION_DATA                       : "3D Information Data",
...
company_names = { # https://www.bluetooth.com/specifications/assigned-numbers/company-identifiers/
...
appearance_names = { # https://specificationrefs.bluetooth.com/assigned-values/Appearance%20Values.pdf
